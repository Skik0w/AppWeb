...
class ZarzadzajProduktami {
    ...
    public function DodajProdukt($tytul, $opis, $data_utworzenia, $data_modyfikacji, $data_wygasniecia, $cena_netto, $vat, $ilosc, $status, $kategoria_id, $gabaryt, $zdjecie) {
    ...
    public function FormEdytujProdukt() {
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '</select><br><br>
                    ...
                    <select id="status" name="status" required>
                        <option value="dostępny" ' . ($row['status'] == 'dostępny' ? 'selected' : '') . '>Dostępny</option>
                        <option value="niedostępny" ' . ($row['status'] == 'niedostępny' ? 'selected' : '') . '>Niedostępny</option>
                        <option value="wycofany" ' . ($row['status'] == 'wycofany' ? 'selected' : '') . '>Wycofany</option>
                        <option value="przedsprzedaż" ' . ($row['status'] == 'przedsprzedaż' ? 'selected' : '') . '>Przedsprzedaż</option>
                    </select><br><br>
