...
// Dołączenie pliku z klasą sklepu
include("sklep.php");
    ...
    if ($_SESSION["is_logged"] == 1) {
        ...
        if ($_GET['action'] == 'categories') {
            ...
            <div class="topnav">
                ...
                <br><br>
                <a href="index.php?idp=9&action=categories&subcategory=edit">Edytuj kategorię</a>
                <br><br>
                <a href="index.php?idp=9&action=categories&subcategory=delete">Usuń kategorię</a>
            </div>';
            ...
            if ($_GET['subcategory'] == 'list') {
                echo '<h3>Aktualne kategorie</h3>';
                $kategorieManager->PokazKategorie();
            } elseif ($_GET['subcategory'] == 'add') {
                $kategorieManager->FormDodajKategorie();
            } elseif ($_GET['subcategory'] == 'edit') {
                $kategorieManager->FormEdytujKategorie();
            } elseif ($_GET['subcategory'] == 'delete') {
                $kategorieManager->FormUsunKategorie();
            }
        }

        // Sekcja zarządzania podstronami
        if ($_GET['action'] == 'pages') {
            echo '<h1>Zarządzaj podstronami</h1>';
            echo "<br>";
            echo '<div class="topnav">';
            echo '<a href="index.php?idp=9&action=pages&subcategory=list">Lista podstron</a>';
            echo "<br><br>";
            echo '<a href="index.php?idp=9&action=pages&subcategory=add">Dodaj nową podstronę</a>';
            echo "<br><br>";
            echo '</div>';
