...
function ListaPodstron()
{
    ...
    echo '<div class="page-list-container">';
                ...
                <td>
                    <div class='action-buttons'>
                        <form method='post' style='display:inline;'>
                            <button type='submit' name='edit{$row['id']}' class='btn-edit'>Edytuj</button>
                        </form>
                        <form method='post' style='display:inline;'>
                            <button type='submit' name='delete{$row['id']}' class='btn-delete'>Usuń</button>
                        </form>
                    </div>
                </td>
              </tr>";
